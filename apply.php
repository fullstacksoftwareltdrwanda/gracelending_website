    ...
    <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-neutral-card border border-white/5 rounded-[2rem] p-8 shadow-xl">
                ...
                <?php if ($track_result): ?>
                    ...
                    <div class="mt-6 p-6 bg-primary-dark rounded-2xl border border-white/5 space-y-4">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-bold">
                            <div>
                                <p class="text-neutral-body opacity-40 uppercase tracking-widest text-[9px] mb-1">Ref Code</p>
                                <p class="text-primary-coral font-black"><?php echo htmlspecialchars($track_result['customer_code']); ?></p>
                            </div>
                            <div>
                                <p class="text-neutral-body opacity-40 uppercase tracking-widest text-[9px] mb-1">Loan Type</p>
                            ...
                            <div>
                                ...
                                <p class="text-primary-coral"><?php echo number_format($track_result['requested_amount']); ?> RWF</p>
                            </div>
                            <div>
                                <p class="text-neutral-body opacity-40 uppercase tracking-widest text-[9px] mb-1">Applied On</p>
                        ...
                        <?php if (!empty($track_result['admin_note'])): ?>
                            <div class="p-4 bg-sky-400/10 border border-sky-400/20 rounded-xl">
                                <p class="text-[9px] font-black uppercase tracking-widest text-sky-400 mb-2"><i class="fas fa-comment-alt mr-1"></i> Note from Grace Lending</p>
                                <p class="text-sm text-sky-300 font-bold"><?php echo htmlspecialchars($track_result['admin_note']); ?></p>
                                <?php if (!empty($track_result['correction_fields'])): ?>
                                    <p class="text-[10px] mt-2 text-sky-400 opacity-70 font-bold uppercase tracking-widest">Fields to update: <?php echo str_replace(',', ', ', htmlspecialchars($track_result['correction_fields'])); ?></p>
                                    
                                    <button type="button" onclick="showCorrectionForm()" class="mt-4 px-6 py-3 bg-sky-500 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-sky-400 transition-all shadow-lg shadow-sky-500/20">
                ...
                <?php if ($success === "updated"): ?>
                    <div class="mt-6 p-6 bg-green-500/10 border border-green-500/20 rounded-3xl text-center">
                        ...
                        <p class="text-neutral-body text-[10px] font-bold mt-2 uppercase">Grace Lending will review your changes shortly.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php if ($success === "created"): ?>
            <div class="p-16 text-center shadow-2xl animate-in bg-neutral-card rounded-[3rem] border border-white/5">
                <div class="w-24 h-24 bg-accent-teal text-white rounded-full flex items-center justify-center mx-auto mb-10 shadow-2xl shadow-accent-teal/20">
                ...
                <div class="bg-primary-dark p-8 rounded-2xl mb-12 border border-white/5">
                    <p class="text-[10px] font-black uppercase tracking-widest opacity-50 mb-3">Your Reference Code — Save This!</p>
                    <p class="text-3xl font-black text-primary-coral tracking-widest"><?php echo $code; ?></p>
                    <p class="text-[10px] text-neutral-body opacity-40 mt-3 font-bold">Use this code above to track your application status</p>
                </div>
                <a href="index.php" class="inline-block bg-primary-coral text-white px-10 py-4 rounded-2xl font-black text-xs tracking-widest transition-all">RETURN TO HOME</a>
            </div>
        <?php else: ?>
            <!-- Application Form -->
            <div class="bg-neutral-card rounded-[3rem] shadow-2xl border border-white/5 animate-in overflow-hidden">
                ...
                <div class="bg-primary-navy p-8 border-b border-white/5 flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        <div id="step-indicator" class="w-10 h-10 rounded-xl bg-primary-coral flex items-center justify-center text-white font-black">1</div>
                        <div>
                            <h2 id="step-title" class="text-xs font-black text-white uppercase tracking-widest">Step 1 of 2</h2>
                            <p id="step-desc" class="text-[10px] text-neutral-body font-bold uppercase opacity-50">Personal Details</p>
                        </div>
                    </div>
                    <!-- Step dots -->
                ...
                <div class="p-10 md:p-16">
                    <div class="mb-12">
                        <h1 class="text-4xl font-black text-neutral-heading mb-3 tracking-tighter uppercase">Loan Application</h1>
                        <p class="text-sm font-bold text-neutral-body opacity-60">Complete the form below to start your funding process.</p>
                    </div>

                    <?php if ($error): ?>
                        <div class="bg-rose-500/10 text-rose-500 p-5 rounded-2xl mb-12 text-xs text-center font-black border border-rose-500/20">
                    ...
                    <form id="loanForm" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div id="step1">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Full Name *</label>
                                    <input type="text" name="customer_name" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="John Doe">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Phone Number *</label>
                                    <input type="tel" name="phone" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="07XXXXXXXX">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">National ID No. *</label>
                                    <input type="text" name="nationalId" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="119XXXXXXXXXXXXX">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Email Address *</label>
                                    <input type="email" name="email" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="name@mail.com">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Loan Product *</label>
                                    <select name="loan_type" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all cursor-pointer">
                                ...
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Amount (RWF) *</label>
                                    <input type="number" name="requested_amount" required class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="e.g. 500000">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Marital Status</label>
                                    <select name="marriage_type" class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Occupation</label>
                                    <input type="text" name="occupation" class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="e.g. Teacher">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Province</label>
                                    <input type="text" name="province" class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="e.g. Kigali">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">District / City</label>
                                    <input type="text" name="location" class="w-full p-5 bg-primary-dark border-2 border-white/5 rounded-2xl text-sm font-bold text-white outline-none focus:border-primary-coral transition-all" placeholder="e.g. Gasabo">
                                </div>
                                <input type="hidden" name="loan_duration" value="12">
                            </div>
                            <button type="button" onclick="goToStep2()" class="w-full bg-primary-coral text-white py-6 rounded-2xl font-black text-xs shadow-2xl hover:opacity-95 transition-all tracking-[0.3em] uppercase">
                        ...
                        <div id="step2" class="hidden space-y-8 animate-in">
                            <div class="p-6 bg-accent-teal/5 border border-accent-teal/20 rounded-2xl text-xs text-accent-teal font-black uppercase tracking-widest">
                                <i class="fas fa-info-circle mr-2"></i>Upload clear copies of your documents. PDF or image files accepted.
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">National ID Copy</label>
                                    <input type="file" name="doc_id" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Work Contract</label>
                                    <input type="file" name="doc_contract" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Bank Statement</label>
                                    <input type="file" name="doc_statement" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Latest Payslip</label>
                                    <input type="file" name="doc_payslip" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">Marital Certificate</label>
                                    <input type="file" name="doc_marital" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase text-neutral-body opacity-50 pl-4 tracking-widest">RDB Certificate</label>
                                    <input type="file" name="doc_rdb" accept=".pdf,.jpg,.jpeg,.png" class="w-full p-4 bg-primary-navy border-2 border-dashed border-white/20 rounded-2xl text-xs font-bold text-white cursor-pointer hover:border-primary-coral/50 transition-all">
                                </div>
                            </div>
                            <div class="flex gap-4 pt-4">
                                <button type="button" onclick="goToStep1()" class="flex-1 bg-primary-navy text-white py-6 rounded-2xl font-black text-xs hover:opacity-90 transition-all uppercase tracking-widest">
                                    <i class="fas fa-arrow-left mr-2"></i> Go Back
                                </button>
                                <button type="submit" name="submit_application" class="flex-[2] bg-primary-coral text-white py-6 rounded-2xl font-black text-xs shadow-2xl hover:opacity-95 transition-all tracking-[0.3em] uppercase">
