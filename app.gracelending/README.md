# gracelending — Accounting & Loan Management System
...
### Installation Steps
1.  **Clone/Upload:** Upload the files to your server (e.g., `htdocs/gracelending_website`).
2.  **Database Config:**
...
5.  **Access:** Open your browser to `http://localhost/app.gracelending/login.php`.
...
---
© 2026 gracelending. Built for precision.
